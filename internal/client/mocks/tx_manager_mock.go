...
//go:generate minimock -i github.com/en7ka/chat-server/internal/client/db.TxManager -o tx_manager_mock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/en7ka/chat-server/internal/client/db"
